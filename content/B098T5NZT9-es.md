...
- ⚠ [Atención] ① El reloj necesita conectarse al teléfono a través de su App, Si no puede conectar el reloj, Cancele la vinculación entre el teléfono y el reloj en la configuración de Bluetooth del teléfono. Luego conecta el reloj a través de la App ② Cuando conecte el reloj por primera vez, active manualmente la función de notificación del reloj en la App (como SMS, Whatsapp) ③ Este reloj no puede contestar llamadas ni responder SMS, pero es suficiente para hacerte saber el contenido del mensaje.
