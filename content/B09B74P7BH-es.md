...
- 📶 【Función WPS】: Un botón para conectarse al enrutador WiFi, presione el botón WPS en el enrutador, luego presione el botón WPS en el dispositivo, espere unos segundos, la instalación habrá finalizado. La luz de señal LED inteligente muestra la intensidad de la señal de la ubicación actual para determinar la ubicación de la mejor cobertura WiFi. El primer medio azul es bueno, el segundo medio rojo cerca del enrutador y el tercer medio azul cerca del enrutador.
- 📶 【Puerto Gigabit Ethernet】GOBRAN repetidor WIFI6 conecta dispositivos cableados, como PC, consolas de juegos, reproductores multimedia de transmisión, etc. Crea una red WiFi 6 muy rápida y confiable para toda la casa y todos los dispositivos a través de un cable módem de red.
...
- 📶 【Compatibilidad universal y alta seguridad】 El repetidor WiFi6 es compatible con todas las cajas de Internet y enrutadores WiFi, y es fácil de instalar. Admite los protocolos de seguridad WiFi inalámbricos WPA-PSK, WPA2-PSK y WPA / WPA2 para proteger mejor sus datos. Si tiene algún problema operativo, comuníquese con el soporte técnico de Gobran. Responderemos en un plazo de 24 horas.
